      ...
      <div className="container mx-auto md:px-6 px-4">
        <div className="space-y-5 px-8 rounded-sm">
          ...
          <div className="relative">
            ...
            {/* Navigation Buttons */}
            <button aria-label="Previous Project" className="swiper-button-prev custom-nav absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-pink-100 transition-all w-10 h-10 flex items-center justify-center">
            ...
            <button aria-label="Next Project" className="swiper-button-next custom-nav absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-pink-100 transition-all w-10 h-10 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" className="w-6 h-6">
